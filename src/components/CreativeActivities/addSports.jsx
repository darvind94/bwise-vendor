                    ...
                    <div className="row">
                        ...
                        <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
                            ...
                            <div className="col-md-12 col-xs-12 mar-top visible-xs">
                                ...
                                <span className="page-title">Add Sports</span>
                            </div>
                                        ...
                                        <div id="company-info" className="tab-pane fade in active">
                                            <form className="custom-form invoice-form col-md-12 col-xs-12 legend-form pad-no">
                                                <div className="row">
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        <label>Academy Name <span className="astrick">*</span></label>
                                                        <input type="text" name="cus-name" className="form-control" />
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Game Type<span className="astrick">*</span></label>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        <label>Sports<span className="astrick">*</span></label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select className='form-control selectpicker' multiple>
                                                                <option key="1" id="1" data-id="1" value="1">Cricket</option>
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        <label>Number of Coach<span className="astrick">*</span></label>
