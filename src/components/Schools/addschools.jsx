...
class Schools extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if ((this.state.owner_name !== '') && (this.state.school_name !== '')) {
            let schoolType = jQuery('#schoolType option:selected').data('status');
            let Classification = jQuery('#classification option:selected').data('status');
            let board_of_edu = jQuery('#board_of_edu option:selected').data('status');
            let gradefrom = jQuery('#gradefrom option:selected').data('status');
            let gradeto= jQuery('#gradeto option:selected').data('status');
            let timefrom = jQuery('#timefrom option:selected').data('status');
            let modeofpayment = jQuery('#modeofpayment option:selected').data('status');
            let minage = jQuery('#minage option:selected').data('status');
            let inst_lang = jQuery('#inst_lang option:selected').data('status');
            let amenities = jQuery('#amenities option:selected').data('status');
            let req_document = jQuery('#req_document option:selected').data('status');
            let addlist = {
                ...
                about_school: this.state.about_school,
    ...
    render() {
        ...
        let school_typeErr = null, classificationErr = null, boardofeduErr = null, gradeErr = null, gradetoErr = null, timefromErr = null, modeofpaymentErr = null, school_logoErr = null, minageErr = null, inst_langErr = null, estyearErr = null, amenitiesErr = null, avg_feesErr = null, other_feesErr = null, admission_feesErr = null, isrefundErr = null;
        for (let err of this.state.errors) {
                                            ...
                                            <form method="post" onSubmit={this.handleSubmit} autoComplete="off" className="custom-form invoice-form col-md-12 col-xs-12 legend-form pad-no">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        ...
                                                        <div name="school_type" id="schoolType" className='custom-select-drop dropdown'>
                                                            <select onChange={this.handleSchoolType} className='form-control selectpicker'>
                                                                <option key="1" id="1" data-id="1" data-status="1" value="1">Day Board </option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{school_typeErr ? school_typeErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Classification<span className="astrick">*</span></label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select name="classification" id="classification" onChange={this.handleClassification} className='form-control selectpicker'>
                                                                <option key="1" data-status="1" data-id="1" value="1">Co-Ed</option>
                                                                <option> Boys</option>
                                                                <option > Girls</option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{classificationErr ? classificationErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Board of Education<span className="astrick">*</span></label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select name="boardofedu" id="board_of_edu" onChange={this.handleBoardOfEducation} className='form-control selectpicker'>
                                                                <option key="1" id="1" data-status="1" data-id="1" value="1">StateBoard</option>
                                                                <option> CBSE</option>
                                                                <option > IB</option>
                                                                <option >ICSE</option>
                                                                <option> Others</option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{boardofeduErr ? boardofeduErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4 input-group-cus">
                                                        <div>
                                                            <label>Grade</label>
                                                            <div className='custom-select-drop dropdown'>
                                                                <select name="grade" id="gradefrom" onChange={this.handleGrade} className='form-control selectpicker'>
                                                                    <option key="1" data-status="1" data-id="1" value="1">Nursery</option>
                                                                    <option> Class 1</option>
                                                                    <option > Class 2</option>
                                                                    <option >--</option>
                                                                    <option> Class 12</option>
                                                                </select><br />
                                                                <small className="alert-msg text-danger">{gradeErr ? gradeErr : ""}</small>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <label>&nbsp;</label>
                                                            <div className='custom-select-drop dropdown'>
                                                                <select name="gradeto" id="gradeto" onChange={this.handlegradeTo} className='form-control selectpicker' >
                                                                    <option key="1" data-status="1" data-id="1" value="1">Nursery</option>
                                                                    <option> Class 1</option>
                                                                    <option > Class 2</option>
                                                                    <option >--</option>
                                                                ...
                                                                <small className="alert-msg text-danger">{gradetoErr ? gradetoErr : ""}</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>School Timing<span className="astrick">*</span></label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select name="timefrom" id="timefrom" onChange={this.handleTimingFrom} className='form-control selectpicker'>
                                                                <option key="1" data-status="1" data-id="1" value="1">9.30Am - 5.00PM </option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{timefromErr ? timefromErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Modes of Payment<span className="astrick">*</span></label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select name="modeofpayment" id="modeofpayment" onChange={this.handleModeOfPayament} className='form-control selectpicker'>
                                                                <option key="1" data-status="1" data-id="1" value="1">Cash/Cheque</option>
                                                                <option key="2">Online Payment</option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{modeofpaymentErr ? modeofpaymentErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>School Logo<span className="astrick">*</span></label>
                                                        <input type="file" value={this.state.logo} onChange={this.handleLogo} className="form-control" />
                                                        <small className="alert-msg text-danger">{school_logoErr ? school_logoErr : ""}</small>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Min Age of Admission</label>
                                                        <div className='custom-select-drop dropdown'>
                                                            <select name="minage" id="minage" value={this.state.minage} onChange={this.handleMinAge} className='form-control selectpicker'>
                                                                <option key="1" data-status="1" data-id="1" value="1">2 Years</option>
                                                                <option>3 Years</option>
                                                                <option>4 Years</option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{minageErr ? minageErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Instruction Language</label>
                                                        <div className="custom-select-drop dropdown">
                                                            <select name="inst_lang" id="inst_lang" value={this.state.inst_lang} onChange={this.handleInstLang} className='form-control selectpicker'>
                                                                <option key="1" data-status="1" data-id="1" value="1">English</option>
                                                                <option>Tamil</option>
                                                                <option>Hindi</option>
                                                            </select><br />
                                                            <small className="alert-msg text-danger">{inst_langErr ? inst_langErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Establishment Year <span className="astrick">*</span></label>
                                                        <input type="text" name="cus-name" value={this.state.estyear} onChange={this.handleEstYear} className="form-control" />
                                                        <small className="alert-msg text-danger">{estyearErr ? estyearErr : ""}</small>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Amenities </label>
                                                        <div className="custom-select-drop dropdown">
                                                            <select name="amenities" id="amenities" onChange={this.handleAmenities} className='form-control selectpicker' data-live-search='true' >
                                                                <option key="1" data-status="1" data-id="1" value="1">Swimming Pool</option>
                                                            ...
                                                            <small className="alert-msg text-danger">{amenitiesErr ? amenitiesErr : ""}</small>
                                                        </div>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Average Fees(Annualy) <span className="astrick">*</span></label>
                                                        <input type="text" name="cus-name" value={this.state.avg_fees} onChange={this.handleAvgFees} className="form-control" />
                                                        <small className="alert-msg text-danger">{avg_feesErr ? avg_feesErr : ""}</small>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Other Fees <span className="astrick">*</span></label>
                                                        <input type="text" name="other_fees" value={this.state.other_fees} onChange={this.handleOtherFees} className="form-control" />
                                                        <small className="alert-msg text-danger">{other_feesErr ? other_feesErr : ""}</small>
                                                    </div>
                                                    <div className="form-group col-md-4">
                                                        <label>Admission Fees <span className="astrick">*</span></label>
                                                        <input type="text" name="admission_fees" value={this.state.admission_fees} onChange={this.handleAdmissionFees} className="form-control" />
                                                        <small className="alert-msg text-danger">{admission_feesErr ? admission_feesErr : ""}</small>
                                                    </div>
                                                    <div className="form-group col-md-4"><label>Is Refundable (Admission Fees)<span className="astrick">*</span></label>
                                                        <br />
                                                        <input type="radio" name="isrefund" onClick={this.handleIsRefund} />Yes&nbsp;&nbsp;
                                                        <input type="radio" name="isrefund" onClick={this.handleIsRefund} />No
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        ...
                                                        <div className="custom-select-drop dropdown">
                                                            <select multiple name="req_document" id="req_document" className='form-control selectpicker' data-live-search='true' >
                                                                <option key="1" data-status="1" data-id="1" value="1">Birth Certificate</option>
                                                                <option key="2" data-status="2" data-id="2" value="2">Aadhar Card</option>
                                                                <option key="3" data-status="3" data-id="3" value="3">Residential Proof</option>
                                                                <option key="4" data-status="4" data-id="4" value="4">Immunization Certficate</option>
                                                                <option key="5" data-status="5" data-id="5" value="5">Passport Size Photos</option>
                                                            </select><br />
